...
Clojure functions for generating random characters and star systems
...
- To experiment with using [[https://github.com/eigenhombre/trav/blob/master/src/trav/chars.clj#L85][small DSLs]] to represent RPG rules and tables
