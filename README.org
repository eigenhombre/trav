...
* Traveller Character and World Generation in Clojure

This repository contains Clojure libraries for generating random
characters and star systems for [[http://en.wikipedia.org/wiki/Traveller_(role-playing_game)][Traveller]], a popular '80s-era science
fiction role playing game (RPG) still being used today.
...
- To experiment with using [[https://github.com/eigenhombre/trav/blob/master/src/trav/chars.clj#L85][small DSLs]] to represent RPG rules and
  tables.  This is something Clojure (or any Lisp) is very good at,
  and which would be hard to do in a similar way in many other
  languages;
